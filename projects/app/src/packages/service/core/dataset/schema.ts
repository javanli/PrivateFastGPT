...
import { DatasetSchemaType } from '@/packages/global/core/dataset/type.d';
import {
  DatasetStatusEnum,
  DatasetStatusMap,
  DatasetTypeMap
...
import {
  PermissionTypeEnum,
  PermissionTypeMap
} from '@/packages/global/support/permission/constant';
...
export const MongoDataset: Model<DatasetSchemaType> = model(DatasetCollectionName, DatasetSchema);
